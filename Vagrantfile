Vagrant.configure("2") do |config|
 ...
 config.vm.provision "ansible" do |ansible|
  ...
  config.vm.define "apps01" do |apps01|
    ...
    apps01.vm.provision "shell", inline: "hostnamectl set-hostname apps01"
  ...
  config.vm.define "apps02" do |apps02|
    ...
    apps02.vm.provision "shell", inline: "hostnamectl set-hostname apps02"
  ...
  config.vm.define "apps03" do |apps03|
    ...
    apps03.vm.provision "shell", inline: "hostnamectl set-hostname apps03"
  ...
  config.vm.define "infra01" do |infra01|
    ...
    infra01.vm.provision "shell", inline: "hostnamectl set-hostname infra01"
    infra01.vm.provision "shell", inline: "service rabbitmq-server restart" # in the define as provisioner ordering is outside-in and we need the hostname first...
  ...
  config.vm.define "infra02" do |infra02|
    ...
    infra02.vm.provision "shell", inline: "hostnamectl set-hostname infra02"
    infra02.vm.provision "shell", inline: "service rabbitmq-server restart" # in the define as provisioner ordering is outside-in and we need the hostname first...
  ...
  config.vm.define "infra03" do |infra03|
    ...
    infra03.vm.provision "shell", inline: "hostnamectl set-hostname infra03"
    infra03.vm.provision "shell", inline: "service rabbitmq-server restart" # in the define as provisioner ordering is outside-in and we need the hostname first...
  ...
  config.vm.define "controller01" do |controller01|
    ...
    controller01.vm.provision "shell", inline: "hostnamectl set-hostname controller01"
  end
